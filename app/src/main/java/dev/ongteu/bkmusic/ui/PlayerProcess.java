...
public class PlayerProcess {
    ...
    public void initPlayerAction(final View viewRoot) {
        ...
        if (mySongigPlayer.getPlayList().size() > 0) {
            ...
            final AppCompatImageView btnPlayAll = (AppCompatImageView) viewRoot.findViewById(R.id.btn_song_play_toggle);
            txtNameSong.setText("Hit button to play all music");
